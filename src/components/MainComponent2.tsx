...
export default function MainComponent2() {
  return (
    ...
    >
      ...
      >
        <h1
          className={`font-ribeye text-[42px] md:text-[50px] w-auto lg:max-w-[476px] lg:text-[52px] lg:h-[207px]`}
        >
        ...
        >
          <p className={`text-left w-auto leading-8`}>
      ...
      <div className={`flex flex-col md:flex-row gap-6 mt-12 mb-12`}>
        <div
